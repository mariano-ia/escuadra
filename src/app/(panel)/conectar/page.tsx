...
export default async function ConectarPage({
  ...
  return (
    <div className="max-w-xl">
      <h1 className="text-3xl mb-2">Conectá tu WhatsApp</h1>
      ...
      <ol className="space-y-6">
        <li className="border border-rule p-5">
          ...
          <p className="text-sm text-grey">
            Desde tu WhatsApp, enviá el mensaje <span className="font-display">join &lt;código-sandbox&gt;</span> al número{" "}
            <span className="font-display text-ink">{sandbox || "(configurar Twilio)"}</span>. (Una sola vez; el
            código de sandbox está en tu consola de Twilio.)
          </p>
        </li>
          ...
          {code ? (
            <div className="mt-2">
              ...
              <p className="text-sm text-grey mt-2">
                Enviá ese código por WhatsApp al mismo número. Vence en 15 minutos.
              </p>
            </div>
          ) : (
      ...
      {code && (
        <form action={generateCodeAction} className="mt-6">
